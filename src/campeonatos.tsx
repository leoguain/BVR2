...
export const campeonatos = [
  {
    ...
    pistas: [
      ...
      { etapa: "3", nome: "Tokyo Exp. Sul R" },
      { etapa: "4", nome: "Mount Panorama" },
      { etapa: "5", nome: "Deep Forest" },
